...
const applianceCategories = ['Kitchen', 'Laundry', 'HVAC', 'Electronics', 'Cleaning', 'Other'] as const;
...
export const validateServiceContact = (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const validateServiceContactUpdate = (req: Request, res: Response, next: NextFunction) => {
  try {
